...
python3 hardware/imu/dm_imu_bridge.py \
...
```text
deploy/configs/command.example
deploy/configs/imu.example
```
...
```bash
./hardware/gamepad/xbox_command_bridge.py \
...
```bash
./hardware/motor/protocol_selftest.py
```
